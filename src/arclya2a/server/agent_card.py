...
def build_agent_card(*, root: Path, base_url: str, version: str, platform_name: str) -> dict[str, Any]:
    ...
    card: dict[str, Any] = {
        ...
        "description": (
            ...
            "self-service package checkout (x402-compatible). External agents can self-register "
            "for a persistent identity (ag_*), manage profiles, and opt in to the public "
            "Agent Directory to discover and be discovered by other agents."
        ),
        "url": public_base,
        "version": version,
        "capabilities": {
